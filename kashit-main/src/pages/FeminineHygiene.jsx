...
import feminineHygieneImg from "../assets/feminine-hygiene.jpeg";
      ...
      <div className="bg-green-600 shadow-sm">
        <div className="w-full py-4">
          <div className="flex items-center justify-between px-4">
            ...
            <h1 className="text-2xl font-bold text-white">Feminine Hygiene</h1>
      ...
      <div className="w-full py-6 max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <p className="text-lg text-gray-600 text-center max-w-3xl mx-auto">
            Essential feminine care products for comfort and confidence. 
            Discreetly delivered to your doorstep in Srinagar.
          </p>
        </div>
