...
export default function Biscuits() {
  ...
  const products = useMemo(() => [
    {
      id: 1,
      name: "Parle-G Original (200g)",
      price: 25,
      originalPrice: 30,
      image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Parle-G",
      rating: 4.5,
      reviews: 128,
      inStock: true
    },
    {
      ...
      price: 35,
      originalPrice: 40,
      image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Monaco",
      rating: 4.3,
      reviews: 89,
      inStock: true
    },
    {
      ...
      price: 45,
      originalPrice: 55,
      image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Oreo",
      rating: 4.7,
      reviews: 156,
      inStock: true
    },
    {
      ...
      price: 39,
      originalPrice: 45,
      image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Marie+Gold",
      rating: 4.2,
      reviews: 67,
      inStock: true
    },
    {
      ...
      price: 55,
      originalPrice: 65,
      image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Good+Day",
      rating: 4.6,
      reviews: 134,
      inStock: false
    },
    {
      ...
      price: 29,
      originalPrice: 35,
      image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Tiger+Krunch",
      rating: 4.4,
      reviews: 189,
      inStock: true
    }
      ...
      <div className="bg-green-600 shadow-sm">
        <div className="w-full py-4">
          <div className="flex items-center justify-between px-4">
            ...
            <h1 className="text-2xl font-bold text-white">Biscuits</h1>
      ...
      <div className="w-full py-8">
        ...
        <div className="mb-8">
          <p className="text-lg text-gray-600 text-center max-w-3xl mx-auto">
            Discover the finest selection of biscuits and cookies. 
            Crunchy, delicious biscuits delivered right to your doorstep in Srinagar.
          </p>
        </div>
