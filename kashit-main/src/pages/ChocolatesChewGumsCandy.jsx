  ...
  const products = useMemo(() => [
    {
      ...
      price: 299,
      originalPrice: 399,
      image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Apples",
      rating: 4.5,
      reviews: 128,
      inStock: true
    },
    {
      ...
      price: 89,
      originalPrice: 99,
      image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Bananas",
      rating: 4.3,
      reviews: 89,
      inStock: true
    },
    {
      ...
      price: 149,
      originalPrice: 199,
      image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Tomatoes",
      rating: 4.7,
      reviews: 156,
      inStock: true
    },
    {
      ...
      price: 79,
      originalPrice: 99,
      image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Carrots",
      rating: 4.2,
      reviews: 67,
      inStock: true
    },
    {
      ...
      price: 59,
      originalPrice: 79,
      image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Spinach",
      rating: 4.6,
      reviews: 134,
      inStock: false
    },
    {
      ...
      price: 129,
      originalPrice: 149,
      image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Onions",
      rating: 4.4,
      reviews: 189,
      inStock: true
    }
      ...
      <div className="bg-green-600 shadow-sm">
        <div className="w-full py-4">
          <div className="flex items-center justify-between px-4">
            ...
            <h1 className="text-2xl font-bold text-white">Fruits & Vegetables</h1>
      ...
      <div className="w-full py-8">
        ...
        <div className="mb-8">
          <p className="text-lg text-gray-600 text-center max-w-3xl mx-auto">
            ...
            Farm-fresh produce delivered right to your doorstep in Srinagar.
          </p>
        </div>
