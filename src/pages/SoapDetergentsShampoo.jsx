...
export default function SoapDetergentsShampoo() {
  ...
  const products = useMemo(() => [
    { id: 1, name: "Toilet Soap (Pack of 3)", price: 99, originalPrice: 129, image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Soap", rating: 4.2, reviews: 142, inStock: true },
    { id: 2, name: "Laundry Detergent (1kg)", price: 149, originalPrice: 179, image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Detergent", rating: 4.3, reviews: 201, inStock: true },
    { id: 3, name: "Shampoo (340ml)", price: 199, originalPrice: 229, image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Shampoo", rating: 4.4, reviews: 178, inStock: true },
    { id: 4, name: "Bathing Bar (Pack of 5)", price: 129, originalPrice: 149, image: "https://via.placeholder.com/200x200/f3f4f6/6b7280?text=Bath+Bar", rating: 4.1, reviews: 64, inStock: true },
  ], []);
      ...
      <div className="bg-green-600 shadow-sm">
        <div className="w-full py-4">
          <div className="flex items-center justify-between px-4">
            ...
            <h1 className="text-2xl font-bold text-white">Soap, Detergents & Shampoo</h1>
            <Link to="/cart" className="relative inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white text-green-700 text-sm font-semibold hover:bg-green-50">
              ...
              {getCartCount() > 0 && (<span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">{getCartCount()}</span>)}
            </Link>
          </div>
        </div>
      </div>
      <div className="w-full py-8">
        <div className="mb-8"><p className="text-lg text-gray-600 text-center max-w-3xl mx-auto">Daily essentials for hygiene and laundry—best picks at the best prices.</p></div>
