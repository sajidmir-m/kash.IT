      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          {localStorage.getItem('accessToken') && (
            <Link
              to="/admin-login"
              className="flex items-center gap-1 px-3 py-2 bg-blue-50 rounded-full shadow hover:bg-blue-100 transition"
              title="Admin Panel"
            >
              <Shield size={20} className="text-blue-700" />
              <span className="text-sm font-medium text-blue-700 hidden sm:inline">Admin</span>
            </Link>
          )}

          {/* Vendor Link - Always show */}
          <Link
            to="/vendor-login"
            className="flex items-center gap-1 px-3 py-2 bg-green-50 rounded-full shadow hover:bg-green-100 transition"
            title="Vendor Portal"
          >
            <Store size={20} className="text-green-700" />
            <span className="text-sm font-medium text-green-700 hidden sm:inline">Vendor</span>
          </Link>
